...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hu7sebe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hu7sebe.containers.anotherwebservice.com/
...
```
git clone git@github.com:Pincopiotta/container-hu7sebe.git
cd container-hu7sebe
```
...
```
docker attach container-hu7sebe
```
